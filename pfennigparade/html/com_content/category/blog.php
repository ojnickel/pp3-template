...
<section class="blog<?php echo '_startseite' === $this->pageclass_sfx ? '_startseite blog_aktuelles' : $this->pageclass_sfx ;?>">
	<?php if ( '_startseite' === $this->pageclass_sfx ) {
...
<?php if ( '_startseite' === $this->pageclass_sfx ) {
	$js = new JSite;
$menu = $js->getMenu();
$link = $menu->getItem(202)->route;
	echo '<a href="/'.$link.'" class="readmore">Alle Beiträge</a>';
} ?>
</section>
